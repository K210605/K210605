...
I'm **Khushi Sehgal**, a B.Tech CSE student specializing in **Cybersecurity & Privacy**.

* 🔐 Exploring **Cybersecurity, SOC Operations & Threat Analysis**
* 💻 Building projects with **Java, Python and JavaFX**
* 🐧 Strengthening my skills in **Linux, Networking and Security Tools**
* 🧩 Practicing **Data Structures & Algorithms** and software development
...
A Java-based cybersecurity toolkit exploring password-cracking techniques, hashing and password-generation approaches.

**Tech:** Java • JavaFX • Maven • Cryptography

### 🌳 MST Visualizer

Interactive visualization of **Kruskal's and Prim's algorithms** for understanding Minimum Spanning Trees.

**Tech:** Java • JavaFX • Algorithms

### 🧮 Matrix Chain Multiplication Visualizer

A GUI-based implementation for visualizing Matrix Chain Multiplication and finding the optimal parenthesization.

**Tech:** Java • JavaFX • Dynamic Programming

### 🛡️ Cybersecurity Labs

Hands-on security practice covering reconnaissance, networking, web security, SQL injection and defensive security concepts.
...
**Cybersecurity Engineering • Software Engineering • SOC & Security Operations**

I'm interested in building secure, reliable and practical solutions while continuously learning new technologies.
